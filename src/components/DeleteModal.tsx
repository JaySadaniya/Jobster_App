    ...
    <Modal open={modal.open} onClose={onClose}>
      ...
      <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
        ...
        <Button
          type="button"
          onClick={onClose}
          removeClass="bg-brand-600 hover:bg-brand-700 text-white border-transparent"
          appendClass="mt-3 w-full bg-white hover:bg-gray-50 text-gray-700 sm:mt-0 sm:w-auto sm:text-sm border-gray-300"
        >
          Cancel
        </Button>
      </div>
