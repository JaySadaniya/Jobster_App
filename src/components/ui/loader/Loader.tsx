...
const Loader: FC<ILoader> = ({ message, className, appendClass, removeClass }) => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className={classes}>
        <Icon appendClass="text-brand-500 h-8 w-8 animate-spin" removeClass="h-5 w-5 text-gray-400">
          <CircleNotchIcon />
        </Icon>
      </div>
